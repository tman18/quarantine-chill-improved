...
function Results(props) {
	...
	return (
		<div>
			<FadeLoader css={override} size={2500} color={'#000000'} loading={props.loader.loading} />
			<main style={{ height: '1000px' }}>
				<div className='movie-column'>
					...
					<div className='movie-selections-results'>
						<div className='movie-image'>
							<img
								alt='Movie Poster'
								src={`https://image.tmdb.org/t/p/w200${props.randomedMovie.poster_path}`}
							/>
						</div>
						<div className='movie-information'>
							<p className='movie-name'>{props.randomedMovie.title || props.randomedMovie.name}</p>
							<p className='movie-summary' style={{ height: '142px' }}>
								{props.movieOverview}
							</p>
							<div className='movie-link-container'>
								<div className='movie-link'>
									...
									>
										Check it out on <img className='imdb-img' alt='IMDB' src={imdb} />
									</a>
								</div>
							</div>
						</div>
				...
				<div className='recipe-column'>
					<div className='recipe-selections-results'>
						...
						<div className='recipe-information'>
							...
							<p className='recipe-summary' style={{ fontSize: '16px', height: '142px' }}>
								{props.recipeInfo.summary}
							</p>
				...
				<button style={{ alignSelf: 'center', marginBottom: '0px' }} onClick={onLoveItClick}>
					Love It!
				</button>
