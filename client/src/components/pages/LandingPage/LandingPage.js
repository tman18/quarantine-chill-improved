...
function LandingPage(props) {
	...
	return (
		<div>
			<div>
				<FadeLoader css={override} size={250} color={'#000000'} loading={props.loader.loading} />
			</div>
			<main>
				{/* movie section */}
					...
					<div className='movie-selections'>
						...
						<div className='movie-options'>
							<div className='labels'>
								...
								<select required onChange={props.onChangeMovie} name='Genre' id='Genre'>
							...
							<div className='labels'>
								...
								<select required onChange={props.onChangeMovie} name='Decade' id='Decade'>
									{[
										'Decade',
										'1950s',
										'1960s',
										...
										<option value={element.slice(0, element.length - 1)} key={index}>
											{' '}
											{element}
										</option>
									))}
							...
							<div className='labels'>
								...
								<select required onChange={props.onChangeMovie} name='Length' id='Length'>
									{[
										'Length',
										'Less than 90 min',
										'90 min - 120 min',
					...
					<div className='recipe-selections'>
						...
						<div className='recipe-options'>
							<div className='labels'>
								...
								<select required onChange={props.onChangeMeal} name='Cuisine Type' id='Cuisine Type'>
							...
							<div className='labels'>
								...
								<select required onChange={props.onChangeMeal} name='Meal Type' id='Meal Type'>
